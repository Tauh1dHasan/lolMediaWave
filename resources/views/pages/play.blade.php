@extends('base.frontEnd')
	@section('content')
		...
		<div class="video-container iq-main-slider">
	      <iframe style="margin-top: 70px; padding: 0 5%" width="100%" height="720" src="https://www.youtube.com/embed/2z4X_kAt4fI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	    </div>
